              ...
              [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 ", callback_data="logi_vida")],
               [InlineKeyboardButton(text=" 𝘼𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙔𝙤𝙪𝙧 𝙂𝙧𝙤𝙪𝙥 ", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],       
                [InlineKeyboardButton(text=" 𝘽𝙖𝙘𝙠", callback_data="logi_"),
                 InlineKeyboardButton(text="", callback_data="logi_helpa")]
              ]
            ),
        )
...
*Note*: @ashleinmusic_bot  works on a single merged commands for Music and Video
...
/sudolist 
- Check Sudo Users of Ashlein Music Bot
...
• [UNO](https://t.me/unomabait) The Doctor, Coder , server manager and developer.
...
*Click below Button to Get Source Code.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="◤𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆", url="https://github.com/uno111551/UnoManagement"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 ...
                 [
                     InlineKeyboardButton(text="𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓", url=f"t.me/unomabait"),
                 ],
                 [
